...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (esTablet()) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.container_detalle_tablet,new DescFragment()).commit();
            RecyclerView recyclerView = findViewById(R.id.recycler_view_productos_tablet);
            ...
            adapter.setOnItemClickListener(((view, position) -> detallesTablet(listaDeProductos.get(position))));
        } else {
    ...
    private List<Producto> obtenerListaDeProductos() {
        return Arrays.asList(
                ...
                new Producto("Microfono", 20,"a al movimiento del puntero en la pantalla.\n" +
                ...
                new Producto("Alfombrilla", 20,"¿Cuál es la función del mouse pad?.\n" +
                ...
                new Producto("USB", 20," El Bus Universal en Serie (BUS) (en inglés: Universal Serial Bus), más conocido por la sigla USB, es un bus de comunicaciones que sigue un estándar que define los cables, conectores y protocolos usados en un bus para conectar, comunicar y proveer de alimentación eléctrica entre computadoras, periféricos y dispositivos electrónicos.\n",R.drawable.usb)
    ...
    public void detallesTablet(Producto producto){
