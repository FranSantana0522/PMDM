...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Verifica si los permisos de la cámara y audio ya están otorgados
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED ||
                ContextCompat.checkSelfPermission(this, android.Manifest.permission.RECORD_AUDIO)
                        != PackageManager.PERMISSION_GRANTED) {
            // Si los permisos no están otorgados, solicítalos al usuario
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // Los permisos de la cámara fueron otorgados, puedes proceder con la lógica de la cámara
                // Por ejemplo, aquí puedes llamar a tu método onCaptureClick() o a otro método para iniciar la captura
            } else {
                // El usuario denegó los permisos, puedes mostrar un mensaje o realizar alguna acción adicional
                // si se necesita permisos de cámara para el funcionamiento de tu app
            }
        }
    }
